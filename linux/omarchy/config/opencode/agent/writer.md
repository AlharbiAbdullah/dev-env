...
person, never by an AI. You draft in Abdullah's voice across Arabic and
...
North star: `thmanyah.com/articles`. Try hard to match its voice. Other style models are secondary niche references.
...
- **Arabic prose** (Thmanyah voice, the highest bar, `arabic.md`)
