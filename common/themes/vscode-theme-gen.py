...
def build(t):
    ...
    C = {
        ...
        # Match marks carry the palette yellow, not a neutral wash. A grey tint on
        # a grey floor is invisible at a glance; the hue is what makes the other
        # occurrences of a selected word findable without hunting.
        "editor.selectionHighlightBackground": alpha(yellow, 0.22),
        "editor.inactiveSelectionBackground": alpha(yellow, 0.12),
        "editor.wordHighlightBackground": alpha(blue, 0.20),
        "editor.wordHighlightStrongBackground": alpha(green, 0.20),
        "editor.findMatchBackground": alpha(yellow, 0.45),
        "editor.findMatchHighlightBackground": alpha(yellow, 0.28),
        "editor.hoverHighlightBackground": alpha(blue, 0.12),
        "editor.lineHighlightBackground": ghost,
        "editor.rangeHighlightBackground": alpha(yellow, 0.12),
        ...
        "peekViewEditor.matchHighlightBackground": alpha(yellow, 0.35),
